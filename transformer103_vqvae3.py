...
class VQVAE2(nn.Module):
    ...
    def encode(self, src_embedding, tgt):
        ...
        for i, enc_layer in enumerate(self.encoder_layers_tgt):
            tgt_embedding = enc_layer(tgt_embedding, None)
    ...
    def decode(self, src_embedding, tgt):
        ...
        for i, dec_layer in enumerate(self.decoder_layers_tgt):
            tgt_embedding = dec_layer(src_embedding, tgt_embedding, None, None)
...
if __name__ == "__main__":
    ...
    train_VQVAE(vqvae, optim, trainset, validset, lr, n_epoch, DEVICE, 20, "model_best_vqvae.pt")
